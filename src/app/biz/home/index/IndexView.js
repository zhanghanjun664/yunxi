        ...
        return (
            <div className="home-page">
                        ...
                        { hotCarList.map((item, index) => {
                            return (
                                <Flex.Item className="car-item" key={'hotcar'+index}>
                                    <img src="assets/images/home/chexing_bg01.png" onClick={ e => { this.goToDetail(e)}}/>
                                </Flex.Item>
                            )
                        })}
                ...
                <div className="home-module discount-cars">
                    <Flex className="home-module-head" justify="center">
                        <span className="icon icon-discount"></span><span>特惠车专区</span>
                    </Flex>
                ...
                <div className="home-module choose-vedio">
                    <Flex className="home-module-head" justify="center">
                        <span className="icon icon-vedio"></span><span>精选视频</span>
                    </Flex>
                    <div className="card">
                ...
                <div className="home-module last-activity">
                    <Flex className="home-module-head" justify="center">
                        <span className="icon icon-activity"></span><span>最新优惠活动</span>
                    </Flex>
                    <div>
