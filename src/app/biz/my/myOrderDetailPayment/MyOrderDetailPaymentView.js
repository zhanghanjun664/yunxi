...
import Style from './MyOrderDetailPaymentLess.less';
import {InputItem, Flex, Button} from 'antd-mobile';

@inject("confirmOrder")
//将组件设置为响应式组件，成为观察者，以便响应被观察数据的变化
@observer
class MyOrderDetailPayment extends Component {
    ...
    render() {
        ...
        let pageClass = 'myorder-detail-payment';
            ...
            <div className={pageClass + "-page btnoptions-fixed"}>
                ...
                <div className={pageClass + "-module " + pageClass + "-orderinfo"}>
                    <Flex className={pageClass + "-module-head f-borderb"} justify="between">
                        ...
                        <div className="text-ready-payment">
                            状态：待支付
                        </div>
                    </Flex>
                ...
                <div className={pageClass + "-module " + pageClass + "-btnoptions"}>
                    <Flex justify="end">
                        <Button className="btn btn_cancel" type="ghost" inline size="small">取消订单</Button>
                        <Button className="btn btn_refund" type="ghost" inline size="small">去支付</Button>
                    </Flex>
                </div>
...
module.exports = MyOrderDetailPayment;
