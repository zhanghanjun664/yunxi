...
import Style from './MySubscribeDetailWaitingLess.less';
import {InputItem, Flex, Button} from 'antd-mobile';

@inject("confirmOrder")
//将组件设置为响应式组件，成为观察者，以便响应被观察数据的变化
@observer
class MySubscribeDetailWaiting extends Component {
    ...
    render() {
        ...
        let pageClass = 'mySubscribe-detail-waiting';
        ...
        return (
            <div className={pageClass + "-page btnoptions-fixed"}>
                ...
                <div className={pageClass + "-module " + pageClass + "-btnoptions"}>
                    <Flex justify="end">
                        <Button className="btn_refund" type="ghost" inline size="small">取消预约</Button>
                    </Flex>
                </div>
...
module.exports = MySubscribeDetailWaiting;
