...
import Style from './MyOrderDetailCancelLess.less';
...
class ConfirmOrder extends Component {
    ...
    render() {
        ...
        let pageClass = 'myorder-detail-cancel';
        ...
        return (
            <div>
                <div className={pageClass + "-page"}>
                    ...
                    <div className="myorder-detail-cancel-module myorder-detail-cancel-payment">
