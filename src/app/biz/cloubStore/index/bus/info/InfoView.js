...
class InfoView extends React.Component {
    ...
    render() {
      ...
      //经销商名称，图片地址，联系电话，星级，门店信息
      let {dealerName,imgUrl,salePhone,score,shops} = dealerInfo ; 
      ...
      return (
        <div className='InfoPage'>
            ...
            </div>
            {
              shops.map(
                (val,i) =>{
                  let _imgUrl = val.imgUrl!=null?val.imgUrl:imgUrl ,
                      _dealerName = val.name!=null?val.name:dealerName ;
                  return (
                    <div className='infoPage-content' key={`shop-key${i}`}>
                      ...
                      <div className='infoPage-content-info'>
                        ...
                        <div className='infoPage-content-info-s'>
                          <StarsList score={score} className='infoPage-content-info-stars' />
                          <div>
                            <span>{score}分</span>
                          </div>
                        </div>
                        <div className='infoPage-content-info-m'>
                          <div className='infoPage-content-info-m-l' onClick={e=>{Util.go2Map(val.address)}}>
                            <i className='iconfont icon-ditu'></i>
                            <p className="p1">到这里</p>
                          </div>
                          <div className='infoPage-content-info-m-r'>
                            <p className="p2">距您{`<`}{
                              this.converKm(val.distance) 
                            }
                            </p>
