...

      {
        ...
        <div className='ci_footer'>
          ...
          <div className='ci_btnBox'>
            <div onClick={this.toUrl.bind(this, '/testdrive?from=carModelDetail&itemId='+this.itemId)}>预约试驾</div>
            <div onClick={this.toUrl.bind(this, '/askprice?from=carModelDetail&itemId='+this.itemId)}>前往询价</div>
          </div>
        </div>
